...
$Proceed = ChoiceMenu -caption "Please Confirm Server Reboot in 10 seconds" -message "Are you Sure You Want To Proceed:" -yesMessage "Server will be rebooted" -noMessage "Nothing will happen" -defaultChoice 1
